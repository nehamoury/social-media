                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <Link to="/" className="flex items-center gap-1 mb-4">
                            ...
                            <span className="text-xl font-bold text-gray-900 tracking-tight">Oren</span>
                        </Link>
                        <p className="text-sm text-gray-500 mb-4">
                            The best place to share and discover amazing videos from creators around the world.
                        </p>
                        <div className="flex gap-4">
                            ...
                            <Link to="#" className="text-gray-400 hover:text-blue-800 transition-colors">
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-2 text-sm text-gray-500">
                            ...
                            <li><Link to="#" className="hover:text-gray-900">Brand</Link></li>
                            <li><Link to="#" className="hover:text-gray-900">Media</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-2 text-sm text-gray-500">
                            ...
                            <li><Link to="#" className="hover:text-gray-900">Community Rules</Link></li>
                            <li><Link to="#" className="hover:text-gray-900">Creator Resources</Link></li>
                        </ul>
                    </div>
                </div>
